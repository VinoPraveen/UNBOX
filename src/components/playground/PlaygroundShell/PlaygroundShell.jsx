...
function defaultValues(inputs) {
  ...
  for (const field of inputs) {
    if (field && typeof field.id === 'string') values[field.id] = field.defaultValue;
  }
  return values;
}
      ...
      <div className="playground__grid">
        <div className="playground__panel">
          ...
          <section className="playground__section" aria-label="Controls">
            ...
            <PlaygroundControls operations={operations} onAction={handleAction} />
          </section>
        </div>

        <div className="playground__panel playground__panel--right">
          <PlaygroundOutput>
            {config.Component ? (
